...
class OrchestrateAgent:
    ...
    def run_agent(self, test_query: str = None, test_user: str = None) -> str:
        """
        Executes the Multi-Agent Pipeline: Security -> Router -> SQL Specialist -> Response
        """
        try:
            user_email = test_user or "user050@empresa.com"
            query_text = test_query or "Which tickets cost more than 500 for the outbound flight?"
